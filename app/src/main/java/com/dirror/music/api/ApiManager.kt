 ...
 * Dso Music 默认 API
 */
const val API_DEFAULT = "https://api.csm.sayqz.com"

/**
 * Dso Music 备用接口
 */
const val API_DSO = "https://api.csm.sayqz.com"
 ...
 */
const val API_MUSIC_ELEUU = "https://api.csm.sayqz.com"

const val API_AUTU = "https://api.csm.sayqz.com"

const val API_LOGIN = API_AUTU

const val API_UPDARE = "https://csm.sayqz.com/api/update/pe/"

const val API_NOTICE = "https://csm.sayqz.com/api/notice/pe/"
